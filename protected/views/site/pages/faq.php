...
<h1>Вопросы и ответы</h1>
	...
	<table class="faq-item">
		...
		<tr>
			<th>A:</th>
			<td>Вы фотографируете яму на дороге (или другой дефект), <a href="http://ukryama.com/personal/add.php" title="Добавить яму или другой дефект дорожного полотна" >добавляете</a> снимок на сайт с указанием адреса (на карте). Готовите документ-обращение в ГАИ, распечатываете и отправляете. Более подробно изложено в разделе &laquo;<a href="/about/#pr" title="О проекте «УкрЯма&raquo;, порядок работы" >Порядок работы</a>».</td>
		</tr>		
	</table>	
	<table class="faq-item">
		<tr>
		...
		<tr>
			<th>A:</th>
			<td>Конечно! Мы практически полностью работаем по разработанному ими алгоритму, но с учетом украинского законодательства. На Украине поддержкой и развитием проекта занимается общественная организация &laquo;<a href="http://novus.org.ua/" title="Общественная организация «Новус&raquo;" target="_blank" >Новус</a>».</td>
		</tr>		
	</table>	
	<table class="faq-item">
		<tr>
