<li<?php if(($index+1)%3==0):?> class="noMargin"<?php endif; ?>>
			...
			<div class="properties">
				<p class="date"><?php echo CHtml::encode(Y::dateFromTime($data->DATE_CREATED)); ?><?php if ($data->comments_cnt) echo CHtml::link('<span class="commentsHot">'.$data->comments_cnt.'</span>', array('view', 'id'=>$data->ID, '#'=>'comments'), Array('title'=>'Комментарии')); else echo CHtml::link('<span class="commentsHot_0">0</span>', array('view', 'id'=>$data->ID, '#'=>'comments'), Array('title'=>'Нет комментариев')); ?></p>
